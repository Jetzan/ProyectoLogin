  ...
  try {
    ...
    if (res.ok) {
      ...
      if (cuenta) {
        ...
        icon:"error",
          text:"Error: respuesta incompleta del servidor. No se permite el acceso."
      });
      }
    } else {
    ...
    Swal.fire({
      icon: "error",
      title: "Error",
      text: "Error de la conexión con el servidor",
    });
  }
});
